...
class KawasakiController():
    ...
    def __init__(self):
        ...
        self.positionArmPub = rospy.Publisher("/KawasakiArm/position_command", brics_actuator.msg.JointPositions, queue_size=1)
        self.torqueArmPub = rospy.Publisher("/KawasakiArm/force_command", brics_actuator.msg.JointTorques, queue_size=1)
        self.velocityArmPub = rospy.Publisher("/KawasakiArm/velocity_command", brics_actuator.msg.JointVelocities, queue_size=1)
